...
public class ColorTest {
	...
	public void testColorHexConstants() {
		...
		validateColor(new Color(ColorConstants.BLACK), 0, "#000000", "#000", 0,
				0, 0, 0.0f, 0.0f, 0.0f);
		validateColor(new Color(ColorConstants.BLUE), 255, "#0000FF", "#00F", 0,
		...
		validateColor(new Color(ColorConstants.GREEN), 65280, "#00FF00", "#0F0",
		...
		validateColor(new Color(ColorConstants.ORANGE, 0.25f), 16753920,
				...
				165, 0, 64, 0.25f, 39.0f, 1.0f, 0.5f);
